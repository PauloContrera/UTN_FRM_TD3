...
%% b) Agregue ruido a la señal senoidal tal que la relación 
% señal a ruido entre la señal senoidal y la señal con ruido sea de 15 dB.
...
plot(frec,mag,'r'); % 'r' = red
hold on
plot(frec_n,mag_n,'b'); % 'b' = blue
plot(frec_f,mag_f,'g'); % 'green' = g
hold off
