...
!Modifique el archivo padre.c para que reciba del proceso hijo 3 caracteres mediante la cola de mensajes declarada como MQ_PATH y
los imprima por consola.
!El padre debe abrir la cola de mensajes MQ_PATH en modo de solo escritura/lectura con los parámetros indicados por la variable attr.

!Se recomienda que el padre elimine la cola de mensajes luego de leer el mensaje enviado por el proceso hijo.

!El proceso hijo recibe como parámetro la variable mqd. 

!Escribe en la cola de mensaje 3 caracteres y cierra la cola de mensaje. 
